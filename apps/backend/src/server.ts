...
import { partnersRoute } from "./modules/partner/partners";
import { usersRoute } from "./modules/user/users";
...
const api = new Elysia({ prefix: "/api" }).use(partnersRoute).use(usersRoute);
